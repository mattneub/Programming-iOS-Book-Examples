...
class ViewController: UIViewController {
    ...
    @IBAction func doButton(_ sender: AnyObject) {
        ...
        let url = NSBundle.main().urlForResource("aboutTiagol", withExtension: "m4a")!
    ...
    @IBAction func doButton2(_ sender: AnyObject) {
        ...
        let url2 = NSBundle.main().urlForResource("Hooded", withExtension: "mp3")!
    ...
    @IBAction func doButton5(_ sender: AnyObject) {
        ...
        let outurl = doc.appendingPathComponent("myfile.aac")
