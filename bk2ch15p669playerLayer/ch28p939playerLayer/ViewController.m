...
- (IBAction)doButton2:(id)sender {
    ...
    [comptrack insertTimeRange:CMTimeRangeMake(CMTimeMakeWithSeconds(dur-5,1), CMTimeMakeWithSeconds(5,1)) ofTrack:track atTime:CMTimeMakeWithSeconds(5,1) error:nil];
