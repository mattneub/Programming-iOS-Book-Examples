...
// generated by migrator, showing how to use a static as a once
class SomeClass {
    private static var __once: () = {
        // this code will run just once in the lifetime of this app
    }()
    func test() {
        _ = SomeClass.__once
    }
...
let qKey = DispatchSpecificKey<String>()
