    ...
    override init() {
        ...
        self.observer =
            ...
            object: nil, queue: NSOperationQueue.mainQueue(), usingBlock: {
                ...
                println("bp player: muting hint notification received") // not receiving this
                ...
                if let sself = self {
                    switch why! {
                    case 1: // began
                        println("bp player: muting hint started at \(sself.player.currentTime)")
                    case 0: // ended
            ...
            NSNotificationCenter.defaultCenter()
                .addObserverForName(
                    ...
                    object: nil, queue: NSOperationQueue.mainQueue(), usingBlock: {
                        ...
                        println("bp hint: \(why)") // always nil
                        if why != nil {
                            if let sself = self {
                                switch why! as UInt {
                                case 1: // began
